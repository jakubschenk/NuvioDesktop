...
internal expect object PlayerSettingsStorage {
    ...
    fun loadRememberVolumeEnabled(): Boolean?
    fun saveRememberVolumeEnabled(enabled: Boolean)
    fun loadDefaultVolumePercent(): Int?
    fun saveDefaultVolumePercent(percent: Int)
