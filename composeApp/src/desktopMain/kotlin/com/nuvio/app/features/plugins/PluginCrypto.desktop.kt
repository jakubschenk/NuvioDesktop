...
internal fun pluginDigestHex(algorithm: String, data: String): String {
    val digest = MessageDigest.getInstance(algorithm.uppercase()).digest(data.encodeToByteArray())
...
internal fun pluginHmacHex(algorithm: String, key: String, data: String): String {
    ...
    return mac.doFinal(data.encodeToByteArray()).toHexString()
}
...
internal fun pluginBase64Decode(data: String): String {
    ...
    return Base64.getDecoder().decode(normalized).decodeToString()
}
